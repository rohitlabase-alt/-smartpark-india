/**
 * Admin operator verification routes (Phase 8, Part 1; docs/API_SPEC.md §2
 * admin). Mounted at /api/v1/admin. Every endpoint requires authentication
 * plus the ADMIN role, enforced server-side via requireAuth + requireRole —
 * client role claims are never trusted (docs/SECURITY.md §5).
 */
